...
public class GamePanel extends JPanel {
    ...
    private GameObject pausedImage = new GameObject(SCREEN_WIDTH / 2 - 200, SCREEN_HEIGHT / 2 - 125, 400, 200, new ImageIcon("data/world/paused.png").getImage(), false);

    private int levelNum = 0;
    private Level level;
    private Player hero;
    private Dragon enemy;
    private SpotLight darkness;
    ...
    class NewFrameListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (enemy.catches(hero)) {
                ...
                if (levelNum > 9) {
                    timer.stop();
                    String name = JOptionPane.showInputDialog(screen, "You escaped in " + elapsedTimeInSeconds + " seconds! Enter your name: ", "Congratulations! You won!", JOptionPane.INFORMATION_MESSAGE);
                    if (name != null) database.putHighScore(name, levelNum, elapsedTimeInSeconds);
                    ...
                    int option = JOptionPane.showConfirmDialog(screen, "Level " + levelNum + " completed! Continue to next level?", "Level Complete", JOptionPane.YES_NO_OPTION);
                    if (option == JOptionPane.YES_OPTION) {
                        restart(levelNum);
                        restartTimer();
                    } else System.exit(0);
